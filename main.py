...
screen = pygame.display.set_mode((WIDTH, HEIGH)) #в скобках высота и ширина соответственно
...
player = Player(WIDTH, HEIGH) # создаем игрока из импортированного на второй строке класса Player
